...
<style type="text/css">
  ...
  <body>
<h1 style="text-align: center;">Employee Hiring Portal</h1>
<div style="font-size: 10pt;">
	<c:choose>
		<c:when test="${empty sessionScope.session_user }">
			<a href="<c:url value='/jsps/Init.jsp'/>" target="_parent">Login</a> |&nbsp;		
			<a href="<c:url value='/jsps/pdata.jsp'/>" target="_parent">WorkersList</a> |&nbsp;
			<a href="<c:url value='/jsps/Deleteaccount.jsp'/>" target="_parent">DeleteAccount</a> |&nbsp;		
			<a href="<c:url value='/jsps/askupdate.jsp'/>" target="_parent">UpdateAccounts</a> 		
